...
[![npm](https://img.shields.io/npm/v/@hoangcung1804npm/ea-eveniet-vitae.svg?style=flat-square)](https://www.npmjs.com/package/@hoangcung1804npm/ea-eveniet-vitae)
[![Downloads](https://img.shields.io/npm/dm/@hoangcung1804npm/ea-eveniet-vitae.svg?style=flat-square)](https://www.npmjs.com/package/@hoangcung1804npm/ea-eveniet-vitae)
...
## Installation
```
npm i @hoangcung1804npm/ea-eveniet-vitae
```
...
```html
<script src="https://unpkg.com/@hoangcung1804npm/ea-eveniet-vitae@latest/dist/@hoangcung1804npm/ea-eveniet-vitae.min.js">
<script>
...
Using `@hoangcung1804npm/ea-eveniet-vitae` Globally:
```js
import vueDebounce from '@hoangcung1804npm/ea-eveniet-vitae'
...
Using `@hoangcung1804npm/ea-eveniet-vitae` at a component level using the option API:
```js
import vueDebounce from '@hoangcung1804npm/ea-eveniet-vitae'
...
```js
import { debounce } from '@hoangcung1804npm/ea-eveniet-vitae'
```
...
```typescript
import Vue from 'vue'
import vueDebounce, { PluginConfig, debounce } from '@hoangcung1804npm/ea-eveniet-vitae'
...
For example, Vuetify makes pretty heavy use of the `onblur` event for a lot of it's styles/animatons, so I'd recommend telling @hoangcung1804npm/ea-eveniet-vitae to listen for `focusout` instead, if you want debounce to trigger on a blur like event.
